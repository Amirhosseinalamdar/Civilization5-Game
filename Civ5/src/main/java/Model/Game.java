...
//        Tile[][] tiles = new Tile[20][20];
    ...
    private static void addResourceToForest(int key, int i, int j) {
    ...
    private static void addResourceToJungle(int key, int i, int j) {
    ...
    private static void addResourceToGrass(int key, int i, int j) {
    ...
    private static void addResourceToPlain(int key, int i, int j) {
    ...
    private static void addResourceToTundra(int key, int i, int j) {
        if (key < 10) tiles[i][j].setResource(Resource.DEER);
    ...
    private static void addResourceToHill(int key, int i, int j) {
        if (key < 10) tiles[i][j].setResource(Resource.DEER);
        else if (key < 20) tiles[i][j].setResource(Resource.SHEEP);
        else if (key < 30) tiles[i][j].setResource(Resource.JEWELERY);
        else if (key < 40) tiles[i][j].setResource(Resource.GOLD);
    ...
    private static void addResourceToDesert(int key, int i, int j) {
    ...
    private static void addResourceToDelta(int key, int i, int j) {
        if (key < 10) tiles[i][j].setResource(Resource.WHEAT);
        else if (key < 20) tiles[i][j].setResource(Resource.SUGAR);
    }

    private static void addResourceToSwamp(int key, int i, int j) {
        if (key < 10) tiles[i][j].setResource(Resource.SUGAR);
    }

    private static void addResourceToSnow(int key, int i, int j) {
    ...
    private static void addResource() {
        ...
        for (int i = 0; i < 20; i++) {
            for (int j = 0; j < 20; j++) {
                ...
                if (tiles[i][j].getFeature() == TerrainFeature.FOREST) addResourceToForest(key, i, j);
                else if (tiles[i][j].getFeature() == TerrainFeature.JUNGLE) addResourceToJungle(key, i, j);
                else if (tiles[i][j].getFeature() == TerrainFeature.SWAMP) addResourceToSwamp(key, i, j);
                else if (tiles[i][j].getFeature() == TerrainFeature.DELTA) addResourceToDelta(key, i, j);
                else if (tiles[i][j].getType() == TerrainType.GRASS) addResourceToGrass(key, i, j);
                else if (tiles[i][j].getType() == TerrainType.PLAIN) addResourceToPlain(key, i, j);
                else if (tiles[i][j].getType() == TerrainType.TUNDRA) addResourceToTundra(key, i, j);
                else if (tiles[i][j].getType() == TerrainType.HILL) addResourceToHill(key, i, j);
                else if (tiles[i][j].getType() == TerrainType.DESERT) addResourceToDesert(key, i, j);
                else if (tiles[i][j].getType() == TerrainType.SNOW) addResourceToSnow(key, i, j);
            }
        }
    }
